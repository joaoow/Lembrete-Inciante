...
int main(){
	...
	printf("[+] C e uma linguagem ESTRUTURADA, ou seja, nao há orientacao a objetos.\n");
	...
	printf("[+] No cabecalho incluímos a biblioteca stdio.h entrada e saída I\\0 \n");
	printf("[+] A funcao main() e a funcao principal, e é do tipo inteira: int \n");
